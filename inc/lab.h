...
public:
    ...
    void buildQuestion(int question = INT_MAX);
    void runQuestion(int question = INT_MAX);
    ...
    void setPDir(std::string pDir);  // Set parent directory and update full
                                     // path
    void setPrefix(std::string prefix);
    void updateFullPath();  // Builds final path pDir+labNum and saves to
                            // dirPath
